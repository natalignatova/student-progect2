...
//        var_dump($routeInfo);
    ...
    protected function generateResponse($content, array $data, $template = 'templateLG.php'){
    ...
    private function render_page($content, array $data, $template)
    {
        extract($data);
        ob_start();
